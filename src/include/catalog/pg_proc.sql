...
-- System-view support functions 
 ...
 CREATE FUNCTION pg_get_partition_path(oid, text, text) RETURNS text LANGUAGE internal STABLE STRICT PARALLEL SAFE AS 'pg_get_partition_path' WITH (OID=7091, DESCRIPTION="partition path for a given relation");
